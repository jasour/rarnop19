...
yq2=[1];for i=1:2*d ;yq2(i+1,1)=(1/(bb2-bb1))*(((bb2)^(i+1) - (bb1)^(i+1))/(i+1));end ;
m=m+yq2;
...
plot(x,I,'r','LineWidth',2);xlim([B1,B2]);ylim([-0.1,1.8]);hold on;grid on; %axis square
xlabel('x');% ylabel('')
 plot([B1,b1,b1,b2,b2,bb1],[0 0 1 1 0 0],'--k','LineWidth',2);%plot([b1,b2],[1 1],'ro')
 plot([b2,bb1,bb1,bb2,bb2,B2],[0 0 1 1 0 0],'--k','LineWidth',2);%plot([b1,b2],[1 1],'ro')
