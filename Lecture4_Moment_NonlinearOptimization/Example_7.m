...
%% Moment Based SDP, This example is the constrained version of example 6
...
%% Plot
[x1,x2]=meshgrid([-1.1:0.01:1.1],[-1.1:0.01:1.1]);
p=x1.^4.*x2.^2+x1.^2.*x2.^4+1-3*x1.^2.*x2.^2;
...
for i=1:4
x1=xx(1,1,i); x2=xx(1,2,i);p=x1.^4*x2.^2+x1.^2.*x2.^4+1-3.*x1.^2.*x2.^2;
