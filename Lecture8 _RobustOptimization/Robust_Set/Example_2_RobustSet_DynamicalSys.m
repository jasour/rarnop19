...
str1 = '$U^d_{R}=\{u: p_d(u) \leq 0 \}$';text(0.4,0.1,str1,'Interpreter','latex','FontSize',30)
...
xlabel('$u$','Interpreter','latex', 'FontSize',40);ylabel('$p_d(u)$','Interpreter','latex', 'FontSize',40);
