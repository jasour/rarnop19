...
plot([-1:0.01:1],Delta*ones(size(x1)),'--','color','red','LineWidth',3)

xlabel('$x$','Interpreter','latex', 'FontSize',31);set(gca,'fontsize',20)
str3 = '$ \int {\mathcal{W}}(x,\omega) d\mu_{\omega}$';text(-0.3,0.4,str3,'HorizontalAlignment','right','Interpreter','latex','FontSize',30,'color','red')  
